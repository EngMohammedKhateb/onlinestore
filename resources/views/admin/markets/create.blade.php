    ...
    <div class="container-fluid  scrolable-page">
        ...
        <div class="row mt-3" >
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="text-danger mb-3 theme-text-color"> <i class='bx bxs-cart-alt' ></i> Create New Market </h4>
                        ...
                        <form action="{{route('admin.markets.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="name" placeholder="Market Name">
                            ...
                            <div class="form-group text-right">
                                <button type="submit" class="btn btn-primary"> <i class='bx bxs-cart-add' ></i> Create Market </button>
                            </div>
                        </form>
                    </div>
                </div>
