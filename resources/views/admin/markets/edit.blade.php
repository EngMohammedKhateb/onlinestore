    ...
    <div class="container-fluid  scrolable-page">
        ...
        <div class="row mt-3" >
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="text-danger mb-3 theme-text-color"><i class='bx bxs-component'></i>Edit Market  {{$market->name}} </h4>

                        <form action="{{route('admin.markets.update',['id'=>$market->id])}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group text-right">
                                <button type="submit" class="btn btn-primary"> <i class='bx bxs-cart-alt' ></i> update market </button>
                            </div>
                        </form>
                    </div>
                </div>
